...
// ValidateInputAndOutputEns ...
func (step StepModel) ValidateInputAndOutputEns(checkRequiredFields bool) error {
...
func (step StepModel) ValidateBeforeShare() error {
	...
	if err := step.ValidateInputAndOutputEns(true); err != nil {
		return err
	}
...
func (step StepModel) Validate() error {
	if err := step.ValidateBeforeShare(); err != nil {
		return err
	}
